  ...
  return (
    <div className="min-h-screen bg-[color:var(--cg-bg)] text-[color:var(--cg-text)]">
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute -top-56 left-1/2 h-[680px] w-[680px] -translate-x-1/2 rounded-full blur-2xl" style={{ background: 'radial-gradient(circle at center,var(--cg-container-a30),transparent 62%)' }} />
      </div>
        ...
        <header className="sticky top-0 z-40 px-8 py-4 border-b border-[color:var(--cg-border)] bg-[color:var(--cg-bg-a72)] backdrop-blur-xl">
          <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <QuickSettings />
              <Link to="/" className="flex items-center gap-2 rounded-xl border border-[color:var(--cg-border)] bg-[color:var(--cg-container-a16)] px-4 py-2 text-xs font-semibold transition hover:bg-[color:var(--cg-container-a22)] hover:border-[#ff7e5f]/30">
                <span className="material-symbols-outlined text-[16px] text-[#ff7e5f]">arrow_back</span>
                Back to Map
              </Link>
            </div>
          </div>
